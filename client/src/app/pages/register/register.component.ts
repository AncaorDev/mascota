...
export class RegisterComponent implements OnInit {
    ...
    private _builderForm() {
        ...
        let form = this._formBuilder.group({
            apellidos   : ['', [Validators.required, Validators.minLength(5), Validators.maxLength(50)]],
            nom_persona : ['', [Validators.required, Validators.minLength(5), Validators.maxLength(50)]],
